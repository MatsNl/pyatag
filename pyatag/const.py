...
CH_MODE = "ch_mode"  # same as CH_OPERATION_MODE
...
SENSOR_TYPES = {
    ...
    "outside_temp_avg": {
        "type": "Average Outside Temperature",
        "unit": "°C",
        "icon": "mdi:thermometer",
        "datafield": "tout_avg",
    },
    WEATHER_STATUS: {
        ...
        "datafield": "weather_status",
    },
    "pcb_temp": {
        "type": "PCB Temperature",
        "unit": "°C",
        "icon": "mdi:thermometer",
        "datafield": "pcb_temp",
    },
    ...
    "ch_water_pressure": {
        "type": "Central Heating Pressure",
        "unit": "bar",
        "icon": "mdi:gauge",
        "datafield": "ch_water_pres",
    },
    "ch_water_temp": {
        "type": "CH Water Temperature",
        "unit": "°C",
        "icon": "mdi:thermometer",
        "datafield": "ch_water_temp",
    },
    "ch_return_temp": {
        "type": "CH Return Temperature",
        "unit": "°C",
        "icon": "mdi:thermometer",
        "datafield": "ch_return_temp",
    },
    DHW_CURRENT_TEMPERATURE: {
        "type": "Hot Water Temp",
        "unit": "°C",
        "icon": "mdi:thermometer",
        "datafield": "dhw_water_temp",
    },
    "dhw_water_pres": {
        "type": "Hot Water Pressure",
        "unit": "bar",
        "icon": "mdi:gauge",
        "datafield": "dhw_water_pres",
    },
    "dhw_flow_rate": {
        "type": "Hot Water Flow Rate",
        "unit": "?",
        "icon": "mdi:gauge",
        "datafield": "dhw_flow_rate",
    },
    BOILER_STATUS: {
        "type": "Boiler Status",
        "unit": "",
        "icon": "mdi:flash",
        "datafield": "boiler_status",
    },
    BOILER_CONF: {
        "type": "Boiler Config",
        "unit": "",
        "icon": "mdi:flash",
        "datafield": "boiler_config",
    },
    "burning_hours": {
        "type": "Burning Hours",
        "unit": "h",
        "icon": "mdi:fire",
        "datafield": "burning_hours",
    },
    "voltage": {
        "type": "Voltage",
        "unit": "V",
...
CONNECTION_STATES = {23: {"state": "Connected to BCU"}}
